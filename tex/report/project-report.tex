...
\begin{figure*}[!t]
	...
	\begin{subfigure}{2.2in}
		\centering
		\includegraphics[width=2.2in]{assets/NumNodes.pdf}
		\caption{\#V}
		\label{numNodesHist}
	\end{subfigure}%
	\begin{subfigure}{2.2in}
		\centering
		\includegraphics[width=2.2in]{assets/NumEdges.pdf}
		\caption{\#E}
		\label{numEdgesHist}
	\end{subfigure}%
	\begin{subfigure}{2.2in}
		\centering
		\includegraphics[width=2.2in]{assets/RelInst.pdf}
		\caption{rel. Inst}
		\label{relInstHist}
	\end{subfigure}
	\begin{subfigure}{2.2in}
		\centering
		\includegraphics[width=2.2in]{assets/NodeDegree.pdf}
		\caption{deg(V)}
		\label{nodDegHist}
	\end{subfigure}%
	\begin{subfigure}{2.2in}
		\centering
		\includegraphics[width=2.2in]{assets/a2a.pdf}
		\caption{a2a}
		\label{a2aHist}
	\end{subfigure}%
	\begin{subfigure}{2.2in}
		\centering
		\includegraphics[width=2.2in]{assets/cvgSource.pdf}
		\caption{cvg src}
		\label{cvgHist}
	\end{subfigure}
