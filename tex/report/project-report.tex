...
We implement a framework to extract the considered architectural change metrics between two commits of a given project.~\sn{Which language is this implemented in }
Figure \ref{frameworkStructure} shows an overview of the structure of our framework.
The complete source code of the framework, as well as our results which are explained later, can be found online\footnote{\url{https://github.com/jodokae/cmput663-architecture}. Note that this is an anonymized GitHub repo to comply with the double blind policy.~\sn{make sure to change the URL}}
...
\sn{this needs another revision}
